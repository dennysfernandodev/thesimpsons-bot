...
const banner2 = cfonts.render((`Obrabo DEV\nBot: The Simpsons BOT\nCriador: +55 61 9433-3182\n`), {
font: 'console',
align: 'center',
gradient: ['red', 'magenta']
});
 
const banner3 = cfonts.render((`Simpsons`), {
  font: 'block',
  align: "center",
  gradient: ['red', 'magenta']
});
...
const authorname = "Obrabo DEV"
const packname = "Criador: @Obrabo DEV"

const chyt = "556194333182@s.whatsapp.net";
const nit = "556194333182@s.whatsapp.net";
const supre = "556194333182@s.whatsapp.net";
